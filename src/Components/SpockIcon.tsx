export default function SpockIcon() {
	return (
		<div className='bg-gray-300 w-20 h-20 rounded-full p-12 lg:p-14 flex justify-center items-center border-[14px] border-cyan-600 ring-4 ring-inset ring-slate-900/20  shadow-md shadow-cyan-900 cursor-pointer transition duration-300 hover:scale-95'>
